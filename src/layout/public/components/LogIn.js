...
export const LogIn=()=>{
    ...
    return(
        <div className="form">
            ...
            <input className="input" type="text" onInput={(e)=>{e.preventDefault();
                               setUsername(e.target.value)}}/><br/>
            <label className="label">Password:</label><br/>
            <input className="input" type="password" onInput={(e)=>{e.preventDefault();
                               setPassword(e.target.value)}}/><br/>
                               <p>{`${error}`}</p>
            <button onClick={handleClick} className="button">LogIn</button><br/>
